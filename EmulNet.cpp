...
int EmulNet::ENsend(Address *myaddr, Address *toaddr, char *data, int size) {
	...
	//printf("Message test before sending: %d\n", ((char *)(data)+1)[0]);
	//printf("Message passed into ENsend: %d:%d:%d:%d:%d\n", ((char *)(data+1))[0], ((char *)(data+1))[1], ((char *)(data+1))[2], ((char *)(data+1))[3], ((char *)(data+1))[4]);
	...
	//printf("Message from emulnet.buff: %d:%d:%d:%d:%d\n", ((char *)(em+1))[0], ((char *)(em+1))[1], ((char *)(em+1))[2], ((char *)(em+1))[3], ((char *)(em+1))[4]);
...
int EmulNet::ENrecv(Address *myaddr, int (* enq)(void *, char *, int), struct timeval *t, int times, void *queue){
	...
	for( i = emulnet.currbuffsize - 1; i >= 0; i-- ) {
		emsg = emulnet.buff[i];
		//printf("Message from emulnet.buff: %d:%d:%d:%d:%d\n", ((char *)(emsg))[0], ((char *)(emsg))[1], ((char *)(emsg))[2], ((char *)(emsg))[3], ((char *)(emsg))[4]);
		...
		if ( 0 == strcmp(emsg->to.addr, myaddr->addr) ) {
			...
			//printf("Message right before calling function pointer enq: %d\n", ((char *)(tmp+1))[0]);
